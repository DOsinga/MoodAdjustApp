...
@interface MoodAdjustAppDelegate ()
...
@property (nonatomic, strong) MoodAdjustViewController *controlLightsViewController;

@end

@implementation MoodAdjustAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MoodAdjustViewController *controlLightsViewController = [[MoodAdjustViewController alloc] initWithNibName:@"MoodAdjustViewController" bundle:[NSBundle mainBundle]];
